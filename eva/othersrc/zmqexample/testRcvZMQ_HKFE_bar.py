...
socket.connect("tcp://192.168.0.45:20132")
...
while (True) :
  ...
  tm = mb.bar
  pstderr(tm.seqnum, tm.ts, tm.contractID, message_pb2.MessageBase.PxType.Name(tm.pxType), tm.nbDec, tm.open, tm.high, tm.low, tm.close, tm.volume, tm.barcnt, tm.wap, tm.gap)
  #tm = mb.tickMsg
