...
req         = pl.request
req.command = API_pb2.Payload.Request.AddOrder 
...
pstderr( "Sent order: " + str(ord.account_id), ord.order_reference )
time.sleep(1)
  
rep = socket.recv()
pl.ParseFromString(rep)
ack = pl.acknowledge.add_order
pstderr( "Rcvd Ack: " + str(ack.account_id), ack.order_reference)
