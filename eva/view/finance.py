...
def candlestick(ax, quotes, width=0.2, colorup='k', colordown='r',
                alpha=1.0, shadowcolor='w', shadowwidth=0.5, \
		showboundary=False,  boundaryedgecolor='w', \
		boundary_alpha=1.0, boundarywidth=2.0):
	...
	if showboundary:
	    margin = 0.1		
	    boundary = Rectangle(\
	    	xy = (t-OFFSET-margin, lower-margin),
	    ...
	    boundary.set_alpha(boundary_alpha)
